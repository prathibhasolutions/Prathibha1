    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_inr', models.DecimalField(decimal_places=2, default=499.0, max_digits=8)),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='technology_bookings', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_at'],
            },
